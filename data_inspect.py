...
'''
try:
    in_file  = h5py.File(fpath, "r")
except:
    print("Error: can't open HDF5 file '%s' for reading (it might be malformed) ..." % fpath)
    sys.exit(-1)
print(in_file.keys())
data = in_file['D1']
grpname = in_file.require_group('D1')
data = in_file['D1/MS1/Attack']
print(data)
print(data.keys())
'''

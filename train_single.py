...
def cnn_2(input_dim=1250,learning_rate=0.00001,classes=256):
...
def cnn_3(input_dim=700,learning_rate=0.00001,classes=256):
...
X_profiling = X_profiling[:args.num_sample]
Y_profiling = Y_profiling[:args.num_sample]



#for i in range(1):
model = cnn_best(input_dim=len(X_profiling[0]))
#model = cnn_3(input_dim=len(X_profiling[0]))
